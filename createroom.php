...
<?php
	...
	$query="INSERT INTO `chat`.`privchatroom` (`id`,`username`,`content`,`room`) VALUES (0,'".$_SESSION['username']."','Chat Room created with id: ".mysqli_insert_id($conn).".','".mysqli_insert_id($conn)."')";
